...
export default function AlarmSetter({ onAlarmChange, onClose }) {
  ...
  async function generateAlarmAudio(alarmDate) {
	...
	// // const wakeReason = await AsyncStorage.getItem("goal")

	// const name = onboarding.name || 'friend';
	// const wakeReason = onboarding.goal || 'No goal provided';

	// console.log("ONBOARDING RAW:", onboardingRaw);
	// console.log("ONBOARDING PARSED:", onboarding);
	...
	// [] Change this file to fit the onboarding
	// If onboarding waketime has value, use that, otherwise
	// create your own, like usual. Easy.
